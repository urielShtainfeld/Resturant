...
//	/*employees[0] = new Butchery(Employee("Ben", 2, 456, 1500));
//	employees[1] = new Butchery(Employee("Maya", 4, 741, 4500));
//	employees[2] = new Waiter(Employee("Charlie", 1, 123, 1000));
//	employees[3] = new Waiter(Employee("Adam", 3, 789, 2000));*/
//	return 4;
//}
//
//int initDishes(Dish** dishes, Ingredient*& ingredients)
...
//
//	// The classic dish
//	dishes[0] = new Dish(130, "Excellent beef served with creamed potatoes", "The classic");
...
//
//	//	The Italian dish
//	dishes[1] = new Dish(60, "Great pasta with creamy tomatoes sauce", "The Italian");
...
//
//	// Chocolate cake
//	dishes[2] = new Dish(42, "Hot chocolate cake", "Amazing chocolate cake");
...
//
//	// Tomatoes salad
//	dishes[3] = new Dish(35, "Sliced tomatoes with cheese, served with hot bread", "Tomatoes salad");
...
//
//	// Carpaccio
//	dishes[4] = new Dish(30, "Thin sliced beef with cheese", "Carpaccio");
